...
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'BIATemplate')
BEGIN
    PRINT 'DROP DATABASE BIATemplate'
    DROP DATABASE BIATemplate;
END;
GO

PRINT 'CREATE DATABASE BIATemplate'
CREATE DATABASE BIATemplate;
GO
