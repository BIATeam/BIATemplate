...
namespace TheBIADevCompany.BIATemplate.Application.User
{
    ...
    /// Auth App Service.
    /// </summary>
    /// <seealso cref="TheBIADevCompany.BIATemplate.Application.User.IAuthAppService" />
    public class AuthAppService : IAuthAppService
    {
        ...
        public async Task<AuthInfoDTO<UserDataDto, AdditionalInfoDto>> LoginOnTeamsAsync(WindowsIdentity identity, LoginParamDto loginParam)
        {
            ...
            if (string.IsNullOrEmpty(sid))
            {
                ...
                throw new UnauthorizedException("Incorrect sid");
            }
            ...
            if (userRoles != null && (userRoles.Contains(Constants.Role.User) || userRoles.Contains(Constants.Role.Admin)))
            {
