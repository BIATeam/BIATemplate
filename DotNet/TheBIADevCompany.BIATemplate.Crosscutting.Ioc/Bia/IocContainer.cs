...
namespace TheBIADevCompany.BIATemplate.Crosscutting.Ioc
{
    ...
    public static partial class IocContainer
    {
        ...
        private static void BiaConfigureApplicationContainer(ParamIocContainer param)
        {
            ...
            param.Collection.Configure<BIATemplate.Application.File.FileDownloaderOptions>(options =>
            {
            ...
            param.Collection.AddTransient<BIA.Net.Core.Application.File.IFileDownloaderService, BIATemplate.Application.File.FileDownloaderService>();
#endif
